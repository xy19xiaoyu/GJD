...
class SubCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post :create, sub_category: { CategoryId: @sub_category.CategoryId, CategoryName: @sub_category.CategoryName, Name: @sub_category.Name }
    end
  ...
  test "should update sub_category" do
    patch :update, id: @sub_category, sub_category: { CategoryId: @sub_category.CategoryId, CategoryName: @sub_category.CategoryName, Name: @sub_category.Name }
    assert_redirected_to sub_category_path(assigns(:sub_category))
  end
