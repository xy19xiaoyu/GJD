...
class GoDownItemsControllerTest < ActionController::TestCase
  ...
  test "should create go_down_item" do
    assert_difference('GoDownItem.count') do
      post :create, go_down_item: { BatchId: @go_down_item.BatchId, CreateTime: @go_down_item.CreateTime, Execer: @go_down_item.Execer, GoDown_id: @go_down_item.GoDown_id, InTime: @go_down_item.InTime, Item_id: @go_down_item.Item_id, MadeIn: @go_down_item.MadeIn, Order_id: @go_down_item.Order_id, ShelfLife: @go_down_item.ShelfLife, State: @go_down_item.State, Sum: @go_down_item.Sum }
    end
  ...
  test "should update go_down_item" do
    patch :update, id: @go_down_item, go_down_item: { BatchId: @go_down_item.BatchId, CreateTime: @go_down_item.CreateTime, Execer: @go_down_item.Execer, GoDown_id: @go_down_item.GoDown_id, InTime: @go_down_item.InTime, Item_id: @go_down_item.Item_id, MadeIn: @go_down_item.MadeIn, Order_id: @go_down_item.Order_id, ShelfLife: @go_down_item.ShelfLife, State: @go_down_item.State, Sum: @go_down_item.Sum }
    assert_redirected_to go_down_item_path(assigns(:go_down_item))
  end
